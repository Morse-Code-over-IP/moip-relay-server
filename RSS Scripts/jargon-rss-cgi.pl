...
#   Robert B. Denny 10-Apr-10   FOr SPecial jargon file. See mkjargidx.pl.
# =============================================================================

$fortfileqts = $ENV{"FORTUNE"} || "c:/cookie/jargon-for-morse.txt";       # Quotes
$fortfileidx = $ENV{"FORTIDX"} || "c:/cookie/jargon-for-morse.idx";       # Index into quotes
#$fortfileqts = $ENV{"FORTUNE"} || "d:/dev/misc/cookie/jargon-for-morse.txt";  # Quotes
#$fortfileidx = $ENV{"FORTIDX"} || "d:/dev/misc/cookie/jargon-for-morse.idx";  # Index into quotes
...
open(QTS, "<$fortfileqts")  || die "Can open jargon, $fortfileqts: $!\n";
...
# -----------------------------------------------------------------------------
# sendfortune() - Send a jargon def, given $maxlen max length in chars
#
