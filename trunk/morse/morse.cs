...
namespace com.dc3.morse
{
	...
	/// target="_blank">Morse Code</a> page. Alternatively, American Morse Code may be generated by first setting <see cref="Mode" />
	...
	/// Morse Code</a> page. In addition, commonly accepted encodings for the equal 
	/// sign '=' and forward slash '/' are included.
	...
	/// Note that split speed timing is not supported for American Morse Code, so in this <see cref="Mode" />
