...
namespace com.dc3
{
	public partial class MainForm : Form
	{
		...
		private const double _amplitude = 0.2;
		private const int _maxDuration = 1000;
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
			...
			_tones = new Tone(_sampleRate, _toneFreq, _amplitude, _maxDuration);
			_sounder = new Sounder(_sounderNum);
